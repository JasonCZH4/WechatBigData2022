...
def parse_args():
    ...
    parser.add_argument('--pretrain_batch_size', default=48, type=int)

    parser.add_argument('--val_batch_size', default=48, type=int, help="use for validation duration per worker")
    parser.add_argument('--test_batch_size', default=48, type=int, help="use for testing duration per worker")
    ...
    parser.add_argument('--savepremodel_path', type=str, default='save/pre_models')
    parser.add_argument('--savedmodel_FGM_path', type=str, default='save/FGM')
    parser.add_argument('--savedmodel_PGD_path', type=str, default='save/PGD')

    parser.add_argument('--ckpt_file', type=str, default='save/PGD/checkpoint/model.bin')
    parser.add_argument('--best_score', default=0.5, type=float, help='save checkpoint if mean_f1 > best_score')
    parser.add_argument('--pretain_load_path', type=str, default='save/pre_models/model_epoch_9.bin')
    ...
    parser.add_argument('--pretrain_max_steps', default=500000, type=int, metavar='N', help='number of total epochs to run')
    parser.add_argument('--pretrain_max_epochs', type=int, default=25, help='How many epochs')
    ...
    parser.add_argument('--bert_max_steps', type=int, default=300000)
