...
### 代码介绍
- [category_id_map.py](src/simple/config/category_id_map.py) 是category_id 和一级、二级分类的映射
- [config.py](src/simple/config/config.py) 是配置文件
- [data_helper.py](src/simple/data_helpers/data_helper.py) 是数据预处理模块
- [evaluate.py](src/simple/evaluate.py) 是线上评测代码示例
- [inference.py](src/simple/inference.py) 是生成提交文件的示例代码
- [main.py](main.py) 是训练模型的入口
- [model.py](model.py) 是baseline模型
- [util.py](src/simple/util.py) 是util函数
